  ...
  constructor() {
    ...
    function
      ...
      for (let i = 0; i < squaresArray.length; i++) {
        ...
        divArray[i].innerHTML =
          `<img draggable="false" src="/assets/chess/${pieceSet}/${colorMap[squaresArray[i].pieceColor]}${pieceMap[squaresArray[i].pieceType]}.${fileTypeMap[pieceSet]}">  `
        // `<img draggable="false" src="/portfolio/assets/chess/${pieceSet}/${colorMap[squaresArray[i].pieceColor]}${pieceMap[squaresArray[i].pieceType]}.${fileTypeMap[pieceSet]}">  `
    ...
    function pieceSelectionPlacePiece(currentPiece) {
    ...
    const buttonForChangingPieces = document.querySelector("[data-change-piece-button]");

    buttonForChangingPieces.addEventListener("click", () => {
      changePieceButton();
    })
